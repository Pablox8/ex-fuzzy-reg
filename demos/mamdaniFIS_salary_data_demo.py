...
def mamdaniFIS_salary_data_demo() -> None:
    # Age,Gender,Education Level,Job Title,Years of Experience,Salary
    # relevant for the demo: Age,Years of Experience, Salary
    data = np.loadtxt('demos/datasets/salary_data.csv', delimiter=',', skiprows=1, usecols=(0, 4, 5))
    
    label_names = ["Age", "Years of Experience", "Salary"]
